  ...
  const [forumPosts, setForumPosts] = useState([
    {
      ...
      UIDP: "8891",
      comments: [
        { UID: "4366", text: "↳ ได้ครับ เด็กวิทคอมเก่งคับ" },
        { UID: "7989", text: "↳ ปริ้นได้ เเต่ซ่อมไม่ได้คับ" },
      ],
    },
  ]);
        ...
        <div className="container px-5 py-10 mx-auto max-w-7xl">
          ...
          <div className="flex flex-col justify-center items-center mb-5">
            ...
            {forumPosts.length > 0 ? (
              <>
                {forumPosts.map((post) => (
                  <div className="mb-4 w-full max-w-2xl" key={post.id}>
                    {/* Top Items */}
            ...
            <form className="mb-6 w-full max-w-2xl" onSubmit={addComment}>
              ...
              <div className="">
                <button
                  ...
                  style={{
                    background:
                      mode === "dark" ? "rgb(226, 232, 240)" : "#3B82F6",
                  }}
