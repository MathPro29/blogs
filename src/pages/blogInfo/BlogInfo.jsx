...
function BlogInfo() {
  ...
  return (
    <Layout>
     <section className="rounded-lg h-full max-w-xl mx-auto px-4">
  <div className="py-4 lg:py-8">
    {loading ? (
      <Loader />
    ) : (
      // Thumbnails
      <div className="overflow-hidden border border-gray-300 p-2">
        {/* Thumbnail */}
        <div className="relative w-full h-auto">
          <img
            alt="content"
            className="mb-3 rounded-lg w-full h-auto object-contain"
